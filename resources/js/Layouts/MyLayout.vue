...
const activeLink = ref(''); // To store the currently active link
...
<template>
    <div>
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-100 nav-container">
                        ...
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink
                                    ...
                                    :active="route().current('dashboard') || activeLink === 'dashboard'"
                                ...
                                <NavLink
                                    ...
                                    :active="route().current('portfolio') || activeLink === 'portfolio'"
